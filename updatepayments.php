                                                    ...
                                                    <?php
                                                        ...
                                                        <tr>
                                                           <td><?php echo $i;?></td>
                                                            ...
                                                            <td><a class="btn btn-dark" href="updateformspayments.php?<?php echo hash('sha512',$row['id']).hash('sha512',$row['invoice'])."&&aid=".$row['id']."&&nid=".$row['invoice']."&&pid=".$row['pstatus'];?>"><?php echo $row['pstatus'];?></a></td>
